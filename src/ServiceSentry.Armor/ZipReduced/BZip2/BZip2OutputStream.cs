...
namespace Ionic.BZip2
{
    ...
    public class BZip2OutputStream : Stream
    {
        ...
        public override void Write(byte[] buffer, int offset, int count)
        {
            ...
            do
            {
                var n = compressor.Fill(buffer, offset, bytesRemaining);
                if (n != bytesRemaining)
                {
