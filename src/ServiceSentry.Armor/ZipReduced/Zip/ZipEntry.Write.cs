...
namespace Ionic.Zip
{
    public partial class ZipEntry
    {
        ...
        internal void WriteCentralDirectoryEntry(Stream s)
        {
            ...
            var vNeeded = (Int16) (VersionNeeded != 0 ? VersionNeeded : 20);
            // workitem 12964
            ...
            var filenameLength = (Int16) fileNameBytes.Length;
            ...
            var extraFieldLength = (Int16) ((_Extra == null) ? 0 : _Extra.Length);
        ...
        private long SetInputAndFigureFileLength(ref Stream input)
        {
            ...
            else if (_Source == ZipEntrySource.ZipFile)
            {
                ...
                var pwd = (_Encryption_FromZipFile == EncryptionAlgorithm.None)
                              ? null
                              : (_Password ?? _container.Password);
            ...
            do
            {
                try
                {
                    ...
                    if (IsDirectory)
                    {
                        ...
                        _OutputUsesZip64 =
                            new Nullable<bool>(_container.Zip64 == Zip64Option.Always || _entryRequiresZip64.Value);
