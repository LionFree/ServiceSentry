...
namespace Ionic.Zip
{
    public partial class ZipFile
    {
        ...
        /// </param>
        /// <returns>
        ///     The <c>ZipEntry</c> corresponding to the File added.
        /// </returns>
        ...
        ///     given file name and directory path, if it exists, and then calling
        ///     <see
        ///         cref="AddEntry(String,WriteDelegate)" />
        ///     .  See the
        ///     documentation for that method for further explanation.
        /// </remarks>
        /// <param name="entryName">
        ...
        ///     given file name and directory path, if it exists, and then calling
        ///     <see
        ///         cref="AddEntry(String,OpenDelegate, CloseDelegate)" />
        ///     .  See the
        ///     documentation for that method for further explanation.
        /// </remarks>
        /// <param name="entryName">
        ...
        /// </param>
        /// <returns>
        ///     The <c>ZipEntry</c> added or updated.
        /// </returns>
        ...
        ///     The content to use for the <c>ZipEntry</c>.
        /// </param>
        /// <returns>
        ///     The <c>ZipEntry</c> added.
        /// </returns>
                                                  ...
                                                  int level)
        {
            if (Verbose)
                StatusMessageTextWriter.WriteLine("{0} {1}...",
                                                  (action == AddOrUpdateAction.AddOnly)
                                                      ? "adding"
                                                      : "Adding or updating",
                                                  directoryName);
