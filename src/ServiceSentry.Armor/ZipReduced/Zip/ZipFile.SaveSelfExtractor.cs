...
namespace Ionic.Zip
{
    ...
    public class SelfExtractorSaveOptions
    {
        ...
        /// </remarks>
        ///
        public String SfxExeWindowTitle { // workitem 12608
            get; set; }
                ...
                using (var csharp = new Microsoft.CSharp.CSharpCodeProvider())
                {
                    ...
                    if (settings == null)
                        throw new BadStateException(
                            String.Format("While saving a Self-Extracting Zip, Cannot find that flavor ({0})?",
                                          options.Flavor));
                    ...
                    using (
                        ZipFile zip =
                            ZipFile.Read(a2.GetManifestResourceStream("Ionic.Zip.Resources.ZippedResources.zip")))
                    {
