    ...
    public class ZipOutputStream : Stream
    {
        ...
        private void _InitiateCurrentEntry(bool finishing)
        {
            ...
            if (_entryCount > 65534 && _zip64 == Zip64Option.Never)
            {
                ...
                throw new System.InvalidOperationException(
                    "Too many entries. Consider setting ZipOutputStream.EnableZip64.");
            }
        ...
        private void _FinishCurrentEntry()
        {
            if (_currentEntry != null)
            {
                ...
                _currentEntry.FinishOutputStream(_outputStream, _outputCounter, _encryptor, _deflater,
                                                 _entryOutputStream);
        ...
        internal Zlib.ParallelDeflateOutputStream ParallelDeflater;
