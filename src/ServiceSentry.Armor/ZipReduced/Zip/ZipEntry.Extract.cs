...
namespace Ionic.Zip
{
    public partial class ZipEntry
    {
        ...
        ///         <see
        ///             cref="Ionic.Zip.ZipEntry.ExtractExistingFile" />
        ///         property, or call
        ///         <see
        ...
        ///         <see
        ///             cref="Ionic.Crc.CrcCalculatorStream" />
        ...
        ///         <see
        ///             cref="Ionic.Crc.CrcCalculatorStream.Crc" />
        ///         property on the
        ...
        private void ValidateCompression()
        {
            if ((_CompressionMethod_FromZipFile != (short) CompressionMethod.None) &&
                ...
                throw new ZipException(String.Format("Entry {0} uses an unsupported compression method (0x{1:X2}, {2})",
                                                     FileName, _CompressionMethod_FromZipFile,
