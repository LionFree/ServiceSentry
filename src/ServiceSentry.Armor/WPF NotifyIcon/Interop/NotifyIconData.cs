...
namespace WPFNotifyIcon.Interop
{
  ...
  public struct NotifyIconData
  {
    ...
    /// </summary>
    internal uint TaskbarIconId;

    /// <summary>
    /// Flags that indicate which of the other members contain valid data. This member can be
    /// a combination of the NIF_XXX constants.
    /// </summary>
    internal IconDataMembers ValidMembers;

    /// <summary>
    /// Application-defined message identifier. The system uses this identifier to send
    /// notifications to the window identified in hWnd.
    /// </summary>
    internal uint CallbackMessageId;
    ...
    /// For example, setting this member to <see cref="WPFNotifyIcon.Interop.IconState.Hidden"/>
    ...
    /// <summary>
    /// Mainly used to set the version when <see cref="NativeMethods.Shell_NotifyIcon"/> 
    /// is invoked with <see cref="NotifyCommand.SetVersion"/>. However, for 
    /// legacy operations, the same member is also used to set timouts for 
    /// balloon ToolTips.
    /// </summary>
    ...
    /// of the tray icon. If this member is non-NULL and the <see cref="WPFNotifyIcon.Interop.BalloonFlags.User"/>
    /// flag is set, this icon is used as the balloon icon.<br/>
    /// If this member is NULL, the legacy behavior is carried out.
    /// </summary>
    internal IntPtr CustomBalloonIconHandle;
